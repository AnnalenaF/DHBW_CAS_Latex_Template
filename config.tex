...
\usepackage[a4paper,left=2.5cm,right=2.5cm,top=2.5cm,bottom=3cm]{geometry} % page spacing
...
\newcommand{\UntertitelDerArbeit}[1]{\def\DerUntertitelDerArbeit{#1}}
...
\ifoot[\rule{0pt}{\ht\strutbox+\dp\strutbox}DHBW CAS]{\rule{0pt}{\ht\strutbox+\dp\strutbox}DHBW CAS}
